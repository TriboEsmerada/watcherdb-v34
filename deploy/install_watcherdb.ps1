# ============================================================
# [DEPRECATED] WatcherDB V3.2 Unified Production Installer
# ============================================================
...
# actual V3.3. O MSI signed e o artefacto canonico a partir de
# Sprint 1 Sem 3-4.
#
...
Write-Host ""
Write-Host "[DEPRECATED] install_watcherdb.ps1 foi deprecado em audit 2026-04-22 (S2-8)." -ForegroundColor Red
Write-Host ""
