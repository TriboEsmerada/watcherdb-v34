// ============================================================================
// WatcherDB PORTAL - PATCH JAVASCRIPT PARA CORRIGIR EXIBIÇÃO
// ============================================================================
// Este arquivo corrige a exibição para mostrar FILEGROUPS em vez de LOGICAL NAMES
// ============================================================================
...
function renderSummary(summary) {
    ...
    summaryContainer.innerHTML = `
        <div class="summary-grid">
            ...
            <div class="summary-card">
                <div class="summary-label">Uso Médio</div>
...
function renderFilegroups(filegroups) {
    ...
    if (!filegroups || filegroups.length === 0) {
        container.innerHTML = '<div class="no-data">Nenhum filegroup encontrado</div>';
        return;
    }
    ...
    card.innerHTML = `
        ...
        <div class="filegroup-body">
            ...
            <div class="filegroup-details">
                <button class="btn-details" onclick="toggleDetails(${index})">
    ...
    if (container) {
        container.innerHTML = `
            <div class="error-message">
                ...
                <p>${message}</p>
                <button class="btn-retry" onclick="retryLoad()">Tentar Novamente</button>
            </div>
        `;
    }
}
