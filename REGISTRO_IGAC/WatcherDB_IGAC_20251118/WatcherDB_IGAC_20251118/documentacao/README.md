...
```bash
# Clone repository
git clone https://github.com/xpto/watcherdb.git
cd watcherdb
...
{
  "metadata": {
    "source_file": "XPTO_SQL_Server_Inventory.xlsx",
...
- **XPTO Team**: Original development and production deployment
...
- **Issues**: https://github.com/xpto/watcherdb/issues
- **Email**: watcherdb@xpto.com
