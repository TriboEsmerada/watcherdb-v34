...
from api.models import DiagnosticsOverviewResponse, DiagnosticsHealthResponse
...
async def get_diagnostics_overview():
    ...
    try:
        ...
        raise safe_http_error(500, e, "loading diagnostics overview")
...
async def get_diagnostics_health():
    ...
    try:
        ...
        raise safe_http_error(500, e, "running diagnostics health check")
