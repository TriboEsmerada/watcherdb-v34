# TestGrapete TG-1c - PASSO 4: semantico completo na 8434 e commit do que ficou fora (smoke+contexto, nightly,
# plano, scripts TG-1c/TG-2/reset). PS7. Corre TU. Pre-requisito: PASSO 3 aplicado; 1 min desde o ultimo login.
...
if (-not (Select-String -Path tests/e2e/test_semantic_e2e.py -Pattern 'TG-1c PASSO 3' -Quiet)) { throw "PASSO 3 nao aplicado. ABORT." }
